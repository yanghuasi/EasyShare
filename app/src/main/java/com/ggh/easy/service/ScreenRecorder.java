...
public class ScreenRecorder extends Thread {
    ...
    public void setScreenDataCallback(ScreenDataCallback screenDataCallback) {
        this.screenDataCallback = screenDataCallback;
    }

    public ScreenRecorder(int width, int height, int bitrate, int dpi, MediaProjection mp, String dstPath, SurfaceHolder surfaceHolder) {
        super(TAG);
        mWidth = width;
        mHeight = height;
        mBitRate = bitrate;
    ...
    private void encodeToVideoTrack(int index) {
        ...
        if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
            // The codec config frameCallback was pulled out and fed to the muxer when we got
        ...
        if (encodedData != null) {
            ...
            encodedData.get(outPutData);
            if (screenDataCallback != null) {
                screenDataCallback.frameCallback(outPutData);
            }
